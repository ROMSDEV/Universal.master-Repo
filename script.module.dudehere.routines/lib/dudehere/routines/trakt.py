...
if _ADDON.get_setting('database_type')=='1':
	DB_NAME = _ADDON.get_setting('database_mysql_name')
	DB_USER = _ADDON.get_setting('database_mysql_user')
	DB_PASS = _ADDON.get_setting('database_mysql_pass')
	DB_PORT = _ADDON.get_setting('database_mysql_port')
	DB_ADDRESS = _ADDON.get_setting('database_mysql_host')
	DB_TYPE = 'mysql'
	...
	DB_FILE = xbmc.translatePath(_ADDON.get_setting('database_sqlite_file'))
...
if DB_TYPE == 'mysql':
	DB=MyDatabaseAPI(DB_ADDRESS, DB_NAME, DB_USER, DB_PASS, DB_PORT, version=DB_VERSION, connect=True, quiet=False)
else:
